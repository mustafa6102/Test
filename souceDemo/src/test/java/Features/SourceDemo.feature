...
Scenario Outline: Empty Password
  ...
  @EmptyUsername
  Scenario Outline: EmptyUsername
    Given  User at home page
    When  write "<password>"for password field
    When  Click login Button
    Then  Click "<error>" message about username
    Examples:
    |password| error |
